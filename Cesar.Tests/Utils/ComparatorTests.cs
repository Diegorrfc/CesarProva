...
namespace Cesar.Tests.Utils
{
    ...
    public class ComparatorTests
    {
        ...
        {
            bool result = Comparators.IsGreaterThan(valueToCompare, ValueComparator);
        ...
        [DataRow("Djavan", 5)]
        [DataRow("Queen", 3)]
        public void ShouldReturnFalseWhenValueToCompareLenghIsGreaterValueComparator(string valueToCompare, int ValueComparator)
        {
        ...
        [TestMethod]
        public void ShouldReturnFalseIfYearOldIsLess18YearOld()
        {
            DateTime yerToCompare = DateTime.Now.AddYears(-16);
